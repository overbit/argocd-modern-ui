...
async function injectIntoActiveTabIfEligible() {
  ...
  try {
    ...
    await chrome.scripting.executeScript({target: {tabId: activeTab.id}, files: ['full-graph-styles.js', 'full-graph.js', 'full-native.js', 'full-changeflow.js', 'full-ui.js', 'full-route.js', 'content.js']});
  } catch (error) {
